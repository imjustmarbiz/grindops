...
const slides: Slide[] = [
    ...
    sections: [
      {
        ...
        points: [
          ...
          "New order drops, payout confirmations, system alerts",
          "Unread count badge on the sidebar",
          "Each notification shows type, severity, and timestamp",
        ],
      },
    ],
    steps: [
      "Check for any unread notifications (sidebar badge shows count)",
      "Click into a notification to mark it as read",
      "Pay special attention to 'warning' severity alerts \u2014 these are urgent",
    ],
    tip: "You'll hear a sound when new notifications arrive. Keep your volume on so you don't miss hot order drops.",
  },
  {
    id: "todo",
    title: "To-Do List",
  ...
  },
  {
    ...
    subtitle: "Link completed work that isn't on your profile yet",
    icon: FileText,
    ...
    sections: [
      {
        ...
        points: [
          "You completed an order that isn't showing in your assignments",
          "An order was assigned outside the system and needs to be recorded",
          "You want credit and payout for work already done",
        ],
      },
      {
        heading: "Claim Form Fields",
        points: [
          ...
          "Dates: Due date, start date, completion date",
          "Payout: Your amount, platform (Cash App, PayPal, etc.), and details",
        ],
      },
    ],
    steps: [
      "Navigate to 'Claim Missing Order' in the sidebar",
      "Enter the Ticket Name (required \u2014 staff uses this to verify)",
      "Fill in Order ID if you know it, or leave blank for staff to create",
      "Select the service type from the dropdown",
      "Add proof links and any relevant dates",
      "Fill in your payout details (amount, platform, cash tag/email)",
      "Click 'Submit Claim' and wait for staff approval",
    ],
    tip: "The more details you provide (especially completion date and proof), the faster staff can approve your claim.",
  },
  {
    id: "my-bids",
    title: "My Bids",
    ...
    tip: "Keep your bid amounts competitive. Check your win rate on the Scorecard page to see how you're doing.",
  },
  {
    id: "my-orders",
  ...
  },
  {
    ...
    tip: "Approve payouts quickly. Delays in your approval hold up the payment process.",
  },
  {
    id: "reviews",
    title: "Reviews",
