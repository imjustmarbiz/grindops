...
import { Plus, ListOrdered, ChevronRight, FileEdit } from "lucide-react";
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Track and manage customer requests.</p>
        </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <FormField control={form.control} name="orderDueDate" render={({ field }) => (
                    <FormItem>
                ...
                <Button type="submit" disabled={createMutation.isPending} className="w-full mt-4 bg-primary hover:bg-primary/90">
        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              return (
                <TableRow key={order.id} className="hover:bg-white/[0.02]">
                  ...
                  <TableCell>{format(new Date(order.orderDueDate), "MMM d, yyyy h:mm a")}</TableCell>
                  <TableCell className="font-bold text-green-400">${order.customerPrice}</TableCell>
                  <TableCell>Lvl {order.complexity}</TableCell>
                  <TableCell>
                    <Select 
