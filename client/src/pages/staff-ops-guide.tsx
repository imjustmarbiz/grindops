...
const slides: Slide[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        points: [
          ...
          "All dashboards auto-refresh every 10\u201330 seconds for live operational data",
        ],
      },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        points: [
          ...
          "Notifications include: new orders, bid decisions, payout changes, grinder updates",
          "Clickable notifications navigate directly to the relevant page",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        points: [
          ...
          "Date range filters: set From and To dates for inclusive date-based filtering",
          "All filters (status, name, dates) apply before categorization \u2014 all sections respect active filters",
          "Clear button resets all filters (status, name, and date range) instantly",
    ...
    steps: [
      "Use filters to narrow down payouts by status, grinder name, or date range",
      "Set From/To dates to view payouts within a specific time period",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Management Tab",
        points: [
          "Elite Requests: approve or deny grinder elite status with decision notes",
          "Strike Logs: review strike history, fine payments, and appeals",
          "Order Limits: set per-grinder capacity limits",
          "Grinder Profiles: edit names, roles, capacity, and Twitch info",
          "Daily Checkup Controls: global and per-order checkup toggles",
          "Task Management: view and delete custom grinder tasks",
        ],
      },
      {
        heading: "System Tab (Owner Only)",
        points: [
          "Bot Data Tracking: toggle automatic data import from the MGT Discord bot",
          "Maintenance Mode: restrict site access (imjustmar only)",
          "Service Management: add, edit, or toggle active status for services",
          "Deletion Requests: approve or deny grinder data deletion requests",
          "Clear Data: purge specific database tables (orders, bids, audit logs)",
        ],
      },
    ],
    steps: [
      "Use the Operations tab for day-to-day order management and alerts",
      "Switch to Management for elite requests, strikes, and grinder profiles",
      "Owners: use the System tab for bot settings, maintenance, and services",
      "Review elite requests by comparing grinder metrics to elite averages",
    ],
    tip: "The Admin page combines what was previously separate Operations and Admin pages. Everything is now in one place with organized tabs.",
  },
  {
    id: "queue",
    title: "AI Queue",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "Bid Acceptance Workflow",
        points: [
          "When you accept a bid, the grinder is prompted to link a Discord ticket channel",
          "Channel ID validation ensures a valid 17\u201320 digit Discord snowflake",
          "Grinders receive a notification when their bid is accepted or denied",
          "Denied grinders also get notified so they can adjust future bids",
        ],
      },
    ],
    steps: [
      ...
      "After acceptance: the grinder will be prompted to link the Discord ticket",
      "Deny bids with reason notes visible to the grinder",
    ],
    tip: "Grinders are notified instantly when you accept or deny their bids. Quick decisions keep the pipeline moving.",
  },
  {
    id: "assignments",
